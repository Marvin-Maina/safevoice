...
class ReportSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'submitted_by_username', 'is_premium_report', 'last_status_update', 'reviewed_by'
        ]
        read_only_fields = ['id', 'status', 'submitted_at', 'token', 'submitted_by', 'is_premium_report', 'last_status_update', 'reviewed_by']
...
class ReportAnalyticsSerializer(serializers.Serializer):
    ...
    reports_by_month = serializers.DictField(child=serializers.IntegerField())
