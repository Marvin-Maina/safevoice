...
# <<< REMOVE THE ENTIRE USER CLASS DEFINITION FROM HERE >>>
...
class AdminAccessRequest(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE) # Use the imported User
...
class Report(models.Model):
    ...
    # Corrected field name: is_premium_report -> is_premium
    is_premium_report = models.BooleanField(default=False) # <<< CHANGED THIS LINE
