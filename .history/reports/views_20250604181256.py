...
class AdminAnalyticsView(generics.GenericAPIView): # <<< IMPORTANT: Changed back to generics.GenericAPIView
    permission_classes = [IsAuthenticated, IsAdminOrPremiumAdmin] # <<< IMPORTANT: Corrected permissions
    serializer_class = ReportAnalyticsSerializer # <<< IMPORTANT: Added serializer_class
