...
class AdminAnalyticsView(APIView):
    permission_classes = [IsAuthenticated]  # or IsAdminOrPremiumAdmin
    ...
    def get(self, request):
        ...
        data = {
            ...
            "escalated": reports.filter(status="escalated").count(),
            "priority": reports.filter(priority=True).count(),
            "anonymous": reports.filter(is_anonymous=True).count(),
        }
