...
class AdminAnalyticsView(generics.GenericAPIView):
    permission_classes = [IsAuthenticated, IsAdminOrPremiumAdmin]
    serializer_class = ReportAnalyticsSerializer # Keep this line, as frontend might still reference it

    def get(self, request, *args, **kwargs):
        # >>> TEMPORARY DEBUGGING: NO SERIALIZER VALIDATION <<<
        print(f"\n--- Entering AdminAnalyticsView.get() (Raw Data Test) ---")
        ...
        if hasattr(Report, 'is_premium_report'):
            ...
            premium_vs_free_reports = {True: 0, False: total_reports}
        ...
        # >>> TEMPORARY DEBUGGING: RETURN RAW DATA <<<
        print(f"--- Returning RAW Data from AdminAnalyticsView: {data} ---") # This print SHOULD appear
        return Response(data) # <<< DIRECTLY RETURN THE DATA DICTIONARY
