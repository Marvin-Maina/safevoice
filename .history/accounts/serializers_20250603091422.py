...
class AdminAccessRequestSerializer(serializers.ModelSerializer):
    # Remap organization_description as 'justification' for cleaner API
    ...
    def create(self, validated_data):
        # This serializer is used for creating new requests, so the user is from the request context
