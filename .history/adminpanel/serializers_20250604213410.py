...
class ReportAnalyticsSerializer(serializers.Serializer):
    ...
    reports_by_category = serializers.DictField(child=serializers.IntegerField()) # Add this
    monthly_trends = serializers.ListField(
        child=serializers.DictField(child=serializers.IntegerField()) # Change CharField to IntegerField
    )
    premium_vs_free_reports = serializers.DictField(child=serializers.IntegerField()) # Add this
    anonymous_vs_identified_reports = serializers.DictField(child=serializers.IntegerField()) # Add this
    priority_reports_count = serializers.IntegerField() # Add this
