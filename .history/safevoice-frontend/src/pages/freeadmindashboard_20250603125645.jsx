              ...
              >
                ...
                <div className="p-4 bg-[#10122a] border-t border-blue-900/20 flex flex-wrap gap-3 justify-end">
                  <button
                    ...
                    className="bg-gray-900 hover:bg-gray-800 text-gray-300 px-4 py-2 rounded-md flex items-center text-sm transition-colors duration-300 border border-gray-700"
                  >
                  ...
                  {report.status !== 'resolved' && report.status !== 'rejected' && (
                    <>
                      <button
                        ...
                        className="bg-gray-900 hover:bg-gray-800 text-gray-300 border border-gray-700 px-4 py-2 rounded-md flex items-center text-sm disabled:opacity-50"
                        disabled={updatingReportId === report.id || report.status === 'under_review'}
                      >
                        {updatingReportId === report.id && report.status === 'pending'
                          ? <Loader2 className="animate-spin mr-2 h-4 w-4 text-gray-400" />
