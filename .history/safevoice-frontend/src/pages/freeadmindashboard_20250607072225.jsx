  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-purple-500/5 to-transparent rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-full blur-2xl animate-pulse delay-500"></div>
      </div>
      ...
      <div className="relative z-10 p-6 sm:p-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-6xl font-extrabold bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent mb-4 flex items-center justify-center gap-4">
          ...
          {/* Analytics Dashboard */}
          <div className="mb-12 p-8 bg-gradient-to-br from-slate-900/80 to-slate-800/60 rounded-3xl shadow-2xl border border-blue-500/20 backdrop-blur-xl relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5 rounded-3xl"></div>
            <div className="relative z-10">
              <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent mb-8 flex items-center gap-4">
              ...
              {analyticsLoading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {/* Total Reports */}
                  <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/40 p-6 rounded-2xl border border-slate-600/30 backdrop-blur-sm hover:scale-105 transition-all duration-300 group">
                  ...
                  {/* Pending */}
                  <div className="bg-gradient-to-br from-yellow-500/20 to-yellow-600/10 p-6 rounded-2xl border border-yellow-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-3">
                  ...
                  {/* Under Review */}
                  <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/10 p-6 rounded-2xl border border-blue-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-3">
                  ...
                  {/* Resolved */}
                  <div className="bg-gradient-to-br from-green-500/20 to-green-600/10 p-6 rounded-2xl border border-green-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-3">
                  ...
                  {/* Rejected */}
                  <div className="bg-gradient-to-br from-red-500/20 to-red-600/10 p-6 rounded-2xl border border-red-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-3">
                  ...
                  {/* Escalated */}
                  <div className="bg-gradient-to-br from-orange-500/20 to-orange-600/10 p-6 rounded-2xl border border-orange-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-3">
                  ...
                  {/* Priority Reports */}
                  <div className="bg-gradient-to-br from-red-500/20 to-pink-500/10 p-6 rounded-2xl border border-red-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-3">
                  ...
                  {/* Anonymous Reports */}
                  <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/10 p-6 rounded-2xl border border-purple-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-3">
          ...
          <div className="mb-8 p-6 bg-gradient-to-r from-slate-900/80 to-slate-800/60 rounded-2xl border border-slate-600/30 backdrop-blur-xl">
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex-grow relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-800/50 border border-slate-600/50 rounded-xl pl-12 pr-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 backdrop-blur-sm transition-all"
                  value={searchQuery}
              ...
              <div className="relative">
                ...
                <select
                  className="bg-slate-800/50 border border-slate-600/50 rounded-xl pl-12 pr-8 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 appearance-none min-w-[200px] backdrop-blur-sm"
              ...
              {/* Status Filter */}
              <select
                className="bg-slate-800/50 border border-slate-600/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 min-w-[180px] backdrop-blur-sm"
                value={filterStatus}
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-600/80 to-blue-700/60 hover:from-blue-500/80 hover:to-blue-600/60 text-white px-6 py-3 rounded-xl transition-all duration-300 flex items-center gap-2 font-medium border border-blue-500/30 backdrop-blur-sm hover:scale-105"
              >
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
              {sortedAndFilteredReports.map((report) => (
                <div
                  key={report.id}
                  className="bg-gradient-to-br from-slate-900/60 to-slate-800/40 rounded-2xl shadow-2xl border border-slate-600/30 hover:border-blue-500/50 transition-all duration-300 flex flex-col backdrop-blur-xl hover:scale-[1.02] group"
                >
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      {report.submitted_by_username && (
                        <div className="flex items-center gap-2 text-gray-300">
                          ...
                          <span className="text-purple-300">{report.submitted_by_username}</span>
                        </div>
                      )}
                  ...
                  {/* Action Buttons */}
                  <div className="p-4 bg-gradient-to-r from-slate-800/60 to-slate-900/40 border-t border-slate-600/30 flex flex-wrap gap-2">
                    <button
                      onClick={() => toggleExpand(report.id)}
                      className="flex-1 bg-gradient-to-r from-gray-700/80 to-gray-800/60 hover:from-blue-600/60 hover:to-blue-700/40 text-white px-3 py-2 rounded-lg flex items-center justify-center text-sm transition-all duration-300 border border-gray-600/30 hover:border-blue-500/50 backdrop-blur-sm"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-blue-600/80 to-blue-700/60 hover:from-blue-500/80 hover:to-blue-600/60 text-white px-3 py-2 rounded-lg flex items-center justify-center text-sm transition-all duration-300 border border-blue-500/30 backdrop-blur-sm"
                    >
                    ...
                    {report.status !== 'resolved' && report.status !== 'rejected' && (
                      <div className="w-full flex gap-2 mt-2">
                        <button
                          ...
                          className="flex-1 bg-gradient-to-r from-blue-600/60 to-blue-700/40 hover:from-blue-500/60 hover:to-blue-600/40 text-blue-200 px-3 py-2 rounded-lg flex items-center justify-center text-sm disabled:opacity-50 transition-all duration-300 border border-blue-500/30 backdrop-blur-sm"
                        ...
                        <button
                          ...
                          className="flex-1 bg-gradient-to-r from-green-600/60 to-green-700/40 hover:from-green-500/60 hover:to-green-600/40 text-green-200 px-3 py-2 rounded-lg flex items-center justify-center text-sm disabled:opacity-50 transition-all duration-300 border border-green-500/30 backdrop-blur-sm"
                        ...
                        <button
                          ...
                          className="flex-1 bg-gradient-to-r from-red-600/60 to-red-700/40 hover:from-red-500/60 hover:to-red-600/40 text-red-200 px-3 py-2 rounded-lg flex items-center justify-center text-sm disabled:opacity-50 transition-all duration-300 border border-red-500/30 backdrop-blur-sm"
                          disabled={updatingReportId === report.id}
                        >
                          {updatingReportId === report.id ? (
                            <Loader2 className="animate-spin mr-2 h-4 w-4" />
