              ...
              >
                ...
                <div className="p-4 bg-[#10122a] border-t border-blue-900/20 flex flex-wrap gap-3 justify-end">
                  <button
                    ...
                    className="bg-gray-900 hover:bg-blue-900/40 text-gray-300 px-4 py-2 rounded-md flex items-center text-sm transition-colors duration-300 border border-gray-700 hover:border-blue-800"
                  >
