...
const MyReportsPage = () => {
  ...
  const fetchMyReports = useCallback(async () => {
    ...
    try {
      ...
      const reportsArray = Array.isArray(response.data.results) ? response.data.results : response.data;
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200 p-6 font-inter relative overflow-hidden">
      {/* Animated gradient circles - same as HeroSection */}
      ...
      {/* Background gradient effect - same as HeroSection */}
        ...
        {selectedReport ? (
          ...
          <div className="max-w-4xl mx-auto bg-gray-800/90 backdrop-blur-sm p-8 rounded-lg shadow-xl border border-gray-700">
            ...
            <div className="mt-6 flex items-center gap-3">
              <textarea
                className="flex-grow p-3 rounded-lg bg-gray-700/80 backdrop-blur-sm border border-gray-600 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 resize-none"
                rows="2"
            ...
            {loadingReports ? (
              ...
              <div className="space-y-6">
                {reports.map((report) => (
                  <div
                    key={report.id}
                    className="bg-gray-800/90 backdrop-blur-sm p-6 rounded-lg shadow-xl border border-gray-700 cursor-pointer hover:border-blue-500 transition-all duration-200"
