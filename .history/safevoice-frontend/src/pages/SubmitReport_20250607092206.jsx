            ...
            <div className="p-6 bg-[#0f1419]/50 rounded-2xl border border-gray-700/30">
              <div className="flex items-start space-x-4">
                <div className="relative">
                  ...
                  >
                    {formData.priority_flag && isPremiumUser && (
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    <Star className={`w-5 h-5 ${isPremiumUser ? 'text-yellow-400' : 'text-gray-500'}`} />
                    <label 
                      htmlFor="priority_flag" 
                      className={`text-sm font-medium cursor-pointer ${
                        isPremiumUser ? 'text-white' : 'text-gray-500'
                      }`}
                    >
                  ...
                  <p className={`text-xs ${isPremiumUser ? 'text-gray-400' : 'text-gray-500'}`}>
                    {isPremiumUser 
