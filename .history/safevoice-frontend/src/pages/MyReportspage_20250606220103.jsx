          ...
          {loadingReports ? (
            ...
            <div className="space-y-6">
              {reports.map((report) => (
                <div
                  key={report.id}
                  className="group bg-gray-800 p-6 rounded-xl shadow-xl border border-gray-700 cursor-pointer hover:border-blue-500/50 hover:bg-gray-800/80 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
