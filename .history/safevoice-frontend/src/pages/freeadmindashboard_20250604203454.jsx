...
const FreeAdminDashboard = () => {
  ...
  // Removed analytics state and related loading state
  ...
  // Removed fetchAnalytics function
  ...
  useEffect(() => {
    fetchReports();
    // Removed analytics fetch from here
    // fetchAnalytics();
  }, [fetchReports]); // Removed fetchAnalytics from dependencies
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200 p-6 font-inter">
      ...
      {/* Removed Analytics Overview Section */}
      {/*
