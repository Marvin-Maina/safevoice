...
const MyReportsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200 p-6 font-inter relative overflow-hidden">
      ...
      <div className="absolute top-3/4 left-1/3 w-80 h-80 bg-purple-600/8 rounded-full filter blur-3xl animate-pulse animation-delay-4000 animation-duration-9000"></div>
      
      {/* Background gradient effect */}
      <div className="absolute inset-0 bg-gradient-to-b from-blue-900/10 via-transparent to-purple-900/5 pointer-events-none" aria-hidden="true"></div>
      ...
      <header className="flex flex-col sm:flex-row justify-between items-center mb-8">
        ...
        <button
          ...
          className="group relative overflow-hidden bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white px-6 py-3 rounded-xl transition-all duration-300 flex items-center space-x-2 border border-gray-600 hover:border-gray-500 shadow-lg hover:shadow-xl"
        >
      ...
      {selectedReport ? (
        ...
        <div className="max-w-4xl mx-auto bg-gray-800/80 backdrop-blur-sm p-8 rounded-xl shadow-2xl border border-gray-700/50">
          <button
            onClick={handleBackToReports}
            className="group mb-6 flex items-center bg-gray-700 hover:bg-gray-600 text-gray-300 hover:text-white px-4 py-2 rounded-lg transition-all duration-200 border border-gray-600 hover:border-gray-500"
          >
          ...
          <h2 className="text-3xl font-bold mb-4 flex items-center">
            <FileText className="mr-3 h-7 w-7 text-green-400" /> 
          ...
          <div className="bg-gray-900/60 backdrop-blur-sm p-4 rounded-lg border border-gray-700/50 mb-6">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            {selectedReport.status !== 'cancelled' && selectedReport.status !== 'resolved' && selectedReport.status !== 'rejected' && (
              <button
                ...
                className="group relative overflow-hidden bg-gray-800 hover:bg-yellow-600 text-gray-300 hover:text-white font-medium py-2.5 px-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl border border-gray-600 hover:border-yellow-500 flex items-center"
              >
            ...
            {selectedReport.status !== 'resolved' && (
              <button
                ...
                className="group relative overflow-hidden bg-gray-800 hover:bg-red-600 text-gray-300 hover:text-white font-medium py-2.5 px-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl border border-gray-600 hover:border-red-500 flex items-center"
              >
            ...
            {selectedReport.status === 'resolved' && (
              <button
                ...
                className="group relative overflow-hidden bg-gray-800 hover:bg-purple-600 text-gray-300 hover:text-white font-medium py-2.5 px-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl border border-gray-600 hover:border-purple-500 flex items-center"
              >
          ...
          <div className="space-y-4 h-96 overflow-y-auto pr-2 custom-scrollbar border border-gray-700/50 rounded-lg p-4 bg-gray-900/40 backdrop-blur-sm">
            {loadingComments ? (
          ...
          <div className="mt-6 flex items-end gap-3">
            <div className="flex-grow">
              <textarea
                className="w-full p-4 rounded-lg bg-gray-700 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 resize-none transition-all duration-200"
                rows="3"
        ...
        <div className="max-w-4xl mx-auto">
          {loadingReports ? (
            ...
            <div className="bg-gray-800/60 backdrop-blur-sm p-8 rounded-xl text-center border border-gray-700/50 shadow-xl">
            ...
            <div className="space-y-6">
              {reports.map((report) => (
                <div
                  key={report.id}
                  className="group bg-gray-800/70 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-gray-700/50 cursor-pointer hover:border-blue-500/50 hover:bg-gray-800/80 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
                ...
                >
                  ...
                  <div className="bg-gray-900/60 backdrop-blur-sm p-3 rounded-lg border border-gray-700/50 mb-4">
