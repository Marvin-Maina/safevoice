...
const BecomeAdmin = () => {
  const [formData, setFormData] = useState({
    applicantType: 'individual', // default to individual admin
    organizationType: '',
    organizationName: '',
    email: '',
    phone: '',
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      request_type: formData.applicantType,             // must match serializer field
      email: formData.email,
      phone: formData.phone,
      organization_description: formData.description,   // remapped from description
    };
