    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 p-6 font-inter">
      <header className="flex flex-col sm:flex-row justify-between items-center mb-8">
        ...
        <button
          ...
          className="text-red-400 hover:text-red-300 text-white font-bold py-2 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 shadow-lg"
        >
          Logout
        </button>
      </header>
