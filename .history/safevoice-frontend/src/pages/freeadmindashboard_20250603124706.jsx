              ...
              >
                ...
                <div className="p-4 bg-[#10122a] border-t border-blue-900/20 flex flex-wrap gap-3 justify-end">
                  ...
                  <button
                    ...
                    className="bg-blue-700 hover:bg-blue-600 text-white px-4 py-2 rounded-md flex items-center text-sm transition-colors duration-300"
                  >
                  ...
                  {report.status !== 'resolved' && report.status !== 'rejected' && (
                    <>
                      <button
                        ...
                        className="bg-blue-800 hover:bg-blue-700 text-white px-4 py-2 rounded-md flex items-center text-sm disabled:opacity-50"
                      ...
                      <button
                        ...
                        className="bg-green-700 hover:bg-green-600 text-white px-4 py-2 rounded-md flex items-center text-sm disabled:opacity-50"
                      ...
                      <button
                        ...
                        className="bg-red-700 hover:bg-red-600 text-white px-4 py-2 rounded-md flex items-center text-sm disabled:opacity-50"
                        disabled={updatingReportId === report.id}
                      >
                        {updatingReportId === report.id
                          ? <Loader2 className="animate-spin mr-2 h-4 w-4" />
