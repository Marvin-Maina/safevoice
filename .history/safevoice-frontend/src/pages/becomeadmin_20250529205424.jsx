...
const BecomeAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Build the payload with keys matching Django serializer expectations
    const payload = {
      request_type: formData.applicantType,               // map applicantType -> request_type
      email: formData.email,
      phone: formData.phone,
      organization_description: formData.description      // description -> organization_description
    };

    if (formData.applicantType === 'organization') {
      payload.organization_type = formData.organizationType;  // add if your model supports it
      payload.organization_name = formData.organizationName;  // map organizationName -> organization_name
    }
