...
const BecomeAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare payload depending on applicantType
    const payload = {
    ...
    // Choose endpoint based on applicantType
    const endpoint =
      formData.applicantType === 'organization'
        ? '/api/admins/org-apply'    // your org endpoint
        : '/api/admins/single-apply'; // your single admin endpoint
  ...
  return (
    <div className="pt-24 pb-16 px-4">
      <div className="max-w-4xl mx-auto">
        {/* ...intro and info boxes remain the same */}
        ...
        <div className="bg-[#111327] p-8 rounded-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Conditionally show org fields only if organization is selected */}
            {formData.applicantType === 'organization' && (
            ...
            {/* Common fields for both single and org */}
            <div className="grid md:grid-cols-2 gap-6">
              <div>
