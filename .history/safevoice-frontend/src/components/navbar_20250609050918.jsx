...
import NotificationDropdown from './NotificationDropdown'; // IMPORT THE NOTIFICATION DROPDOWN
        ...
        {isLoggedIn && (
          <>
           {isSuperuser === 'true' ? (
            ...
            <div className="px-3 py-2"> {/* Wrapper for better spacing in mobile menu */}
                <NotificationDropdown /> {/* */}
            </div>
